...
impl FuzzingContract {
    ...
    pub fn claim(&mut self, env: Env, claimant: soroban_sdk::Address, amount: i128) {
        claimant.require_auth_for_args((amount).into_val(&env));
    }
}
...
impl FuzzingContract {
    ...
    fn func25(&mut self, env: &Env, mut arg0: i32) {
        ...
        self.global0 = var1;
        let var8 = self.func26(env, 1);
        var2 = var8;
        let var9 = self.memory.load64(arg0 as usize) as i64;
        let var10 = self.memory.load64(arg0 as usize + 8) as i64;
        self.func22(env, var1.wrapping_add(48), var9, var10);
        'label0: loop {
            'label1: loop {
                'label2: loop {
                    let mut slot_var1_48_i32 = self.memory.load32(var1 as usize + 48) as i32;
                    if slot_var1_48_i32 != 0 {
                        break 'label2;
                    }
                    let mut slot_var1_56_i64 = self.memory.load64(var1 as usize + 56) as i64;
                    var3 = slot_var1_56_i64;
                    let var12 = self.memory.load64(arg0 as usize + 24) as i64;
                    var4 = var12;
                    'label3: loop {
                        'label4: loop {
                            let var13 = self.memory.load8(arg0 as usize + 40) as i32;
                            if (var13 != 1) as i32 != 0 {
                                break 'label4;
                            }
                            self.func27(env, var1.wrapping_add(48), 1048593, 5);
                            if slot_var1_48_i32 != 0 {
                                break 'label2;
                            }
                            self.func28(env, var1.wrapping_add(48), slot_var1_56_i64);
                            break 'label3;
                            break;
                        }
                        self.func27(env, var1.wrapping_add(48), 1048587, 6);
                        if slot_var1_48_i32 != 0 {
                            break 'label2;
                        }
                        self.func28(env, var1.wrapping_add(48), slot_var1_56_i64);
                    ...
                    if slot_var1_48_i32 as i32 != 0 {
                        break 'label2;
                    }
                    let var18 = self.memory.load64(arg0 as usize + 32) as i64;
                    var6 = var18;
                    if (var6 as u64 > 72057594037927935 as u64) as i32 != 0 {
                        break 'label1;
                    }
                    var6 = var6.wrapping_shl(0 as u32) | 0;
                    break 'label0;
                    break;
                }
                unreachable!();
            ...
            let var19 = val_to_i64(Val::from_u64(var6 as u64))
            var6 = var19;
            break;
        }
        let mut slot_var1_40_i64 = var6 as i64;
        let mut slot_var1_32_i64 = var5 as i64;
        let var20 = self.func29(env, 1048632, 2, var1.wrapping_add(32), 2);
        let mut slot_var1_16_i64 = var20 as i64;
        let mut slot_var1_8_i64 = var4 as i64;
        let mut slot_var1_0_i64 = var3 as i64;
        let var21 = self.memory.load64(arg0 as usize + 16) as i64;
        let mut slot_var1_24_i64 = var21 as i64;
        let var22 = self.func29(env, 1048680, 4, var1, 4);
        self.func30(env, var2, var22);
        self.global0 = var1.wrapping_add(64);
    }
    fn func26(&mut self, env: &Env, mut arg0: i32) -> i64 {
        let mut var1: i32 = 0;
        let mut var2: i64 = 0;
            ...
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        ...
                        self.func27(env, var1, 1048580, 7);
                        ...
                        self.func28(env, var1, slot_var1_8_i64);
                        break 'label2;
                        break;
                    }
                    self.func27(env, var1, 1048576, 4);
                    if slot_var1_0_i32 != 0 {
                        break 'label1;
                    }
                    self.func28(env, var1, slot_var1_8_i64);
    ...
    fn func27(&mut self, env: &Env, mut arg0: i32, mut arg1: i32, mut arg2: i32) {
        let mut var3: i32 = 0;
        let mut var4: i64 = 0;
        let mut var5: i32 = 0;
        let mut var6: i32 = 0;
    ...
    fn func29(&mut self, env: &Env, mut arg0: i32, mut arg1: i32, mut arg2: i32, mut arg3: i32) -> i64 {
        'label0: loop {
    ...
    fn func30(&mut self, env: &Env, mut arg0: i64, mut arg1: i64) {
        let var2 = match 1 /* True */ { 0 => { env.storage().persistent().set(&val_from_i64(arg0), &val_from_i64(arg1)); 0 }, 1 => { env.storage().temporary().set(&val_from_i64(arg0), &val_from_i64(arg1)); 0 }, _ => { env.storage().instance().set(&val_from_i64(arg0), &val_from_i64(arg1)); 0 } }
        var2;
    }
    fn func31(&mut self, env: &Env, mut arg0: i32, mut arg1: i64) {
        ...
        'label2: loop {
            ...
            var3 = 2;
            self.func32(env, arg1, 1048632, 2, var2, 2);
            ...
            'label4: loop {
                'label5: loop {
                    ...
                    let var12 = self.func33(env, 1, var5);
                    if var12 != 0 {
                        break 'label2;
                    }
                    var6 = 0;
                ...
                var6 = 1;
                let var13 = self.func33(env, 1, var5);
                if var13 != 0 {
                    break 'label2;
                }
                break;
    ...
    fn func32(&mut self, env: &Env, mut arg0: i64, mut arg1: i32, mut arg2: i32, mut arg3: i32, mut arg4: i32) {
        'label0: loop {
    ...
    fn func33(&mut self, env: &Env, mut arg0: i32, mut arg1: i32) -> i32 {
        'label0: loop {
    ...
    fn func34(&mut self, env: &Env, mut from: i64, mut token: i64, mut amount: i64, mut claimants: i64, mut time_bound: i64) -> i64 {
        let mut var5: i32 = 0;
        let mut var6: i64 = 0;
        let mut var7: i32 = 0;
        let var8 = self.global0;
        var5 = var8.wrapping_sub(48);
        self.global0 = var5;
        'label0: loop {
            'label1: loop {
                ...
                self.func31(env, var5, time_bound);
                let var11 = self.memory.load8(var5 as usize + 8) as i32;
                var7 = var11;
                if (var7 == 2) as i32 != 0 {
                    break 'label1;
                }
                if ({ let a = (var6 == 0) as i32; let b = (amount < 0 /* False */) as i32; if (amount == 0) as i32 != 0 { a } else { b } }) != 0 {
                    break 'label0;
                }
                time_bound = slot_var5_0_i32;
                let var12 = Vec::<Val>::from_val(env, &val_from_i64(claimants)).len() as i64
                if ((var12 as u64) < 4294967296 as u64) as i32 != 0 {
                    break 'label0;
                }
                let var13 = Vec::<Val>::from_val(env, &val_from_i64(claimants)).len() as i64
                if (var13 as u64 > 47244640255 as u64) as i32 != 0 {
                    break 'label0;
                }
                let var14 = self.func26(env, 0);
                let var15 = self.func36(env, var14);
                if var15 != 0 {
                    break 'label0;
                }
                let var16 = { address_from_i64(env, from).require_auth(); 0 }
                var16;
                let var17 = val_to_i64(env.current_contract_address().into_val(env))
                self.func21(env, token, from, var17, var6, amount);
                let mut slot_var5_8_i64 = amount as i64;
                let mut slot_var5_0_i64 = var6 as i64;
                self.memory.store8(var5 as usize + 40, var7 as u8);
                let mut slot_var5_32_i64 = time_bound as i64;
                slot_var5_24_i64 = claimants as i64;
                slot_var5_16_i64 = token as i64;
                self.func25(env, var5);
                let var20 = self.func26(env, 0);
                self.func30(env, var20, 0 /* Void */);
                self.global0 = var5.wrapping_add(48);
                return 0 /* Void */;
                break;
            }
    ...
    fn func35(&mut self, env: &Env, mut arg0: i32, mut arg1: i64) {
        let mut var2: i32 = 0;
        let mut var3: i64 = 0;
        'label0: loop {
            'label1: loop {
    ...
    fn func36(&mut self, env: &Env, mut arg0: i64) -> i32 {
        let var1 = match 1 /* True */ { 0 => { if env.storage().persistent().has(&val_from_i64(arg0)) { 1 } else { 0 } }, 1 => { if env.storage().temporary().has(&val_from_i64(arg0)) { 1 } else { 0 } }, _ => { if env.storage().instance().has(&val_from_i64(arg0)) { 1 } else { 0 } } }
        (var1 == 1 /* True */) as i32
    }
    fn func37(&mut self, env: &Env) {
        unreachable!();
    }
    fn func38(&mut self, env: &Env, mut claimant: i64, mut amount: i64) -> i64 {
        let mut var2: i32 = 0;
        let mut var3: i64 = 0;
        let mut var4: i64 = 0;
        let mut var5: i32 = 0;
            ...
            'label1: loop {
                'label2: loop {
                    'label3: loop {
                        ...
                        let var14 = { address_from_i64(env, claimant).require_auth(); 0 }
                        var14;
                        let var15 = self.func26(env, 1);
                        var4 = var15;
                        let var16 = self.func36(env, var4);
                        if (var16 == 0) as i32 != 0 {
                            break 'label2;
                        }
                        let var17 = match 1 /* True */ { 0 => { val_to_i64(env.storage().persistent().get::<_, Val>(&val_from_i64(var4)).unwrap_or(val_from_i64(0))) }, 1 => { val_to_i64(env.storage().temporary().get::<_, Val>(&val_from_i64(var4)).unwrap_or(val_from_i64(0))) }, _ => { val_to_i64(env.storage().instance().get::<_, Val>(&val_from_i64(var4)).unwrap_or(val_from_i64(0))) } }
                        var4 = var17;
                        var5 = 0;
                        'label4: loop {
                            'label5: loop {
                                ...
                                self.memory.store64(var2.wrapping_add(48).wrapping_add(var5) as usize, 0 /* Void */ as u64);
                        ...
                        self.func32(env, var4, 1048680, 4, var2.wrapping_add(48), 4);
                        let mut slot_var2_48_i64 = self.memory.load64(var2 as usize + 48) as i64;
                        self.func35(env, var2, slot_var2_48_i64);
                        if (slot_var2_0_i32 == 1) as i32 != 0 {
                            break 'label3;
                        }
                        let mut slot_var2_56_i64 = self.memory.load64(var2 as usize + 56) as i64;
                        var6 = slot_var2_56_i64;
                        if (!(Vec::<Val>::try_from_val(env, &val_from_i64(var6)).is_ok())) as i32 != 0 {
                            break 'label3;
                        }
                        var4 = slot_var2_24_i64;
                        var7 = slot_var2_16_i64;
                        let mut slot_var2_64_i64 = self.memory.load64(var2 as usize + 64) as i64;
                        self.func31(env, var2, slot_var2_64_i64);
                        let var21 = self.memory.load8(var2 as usize + 8) as i32;
                        var5 = var21;
                        if (var5 == 2) as i32 != 0 {
                            break 'label3;
                        }
                        let mut slot_var2_72_i64 = self.memory.load64(var2 as usize + 72) as i64;
                        var8 = slot_var2_72_i64;
                        if (!(Address::try_from_val(env, &val_from_i64(var8)).is_ok())) as i32 != 0 {
                            break 'label3;
                        }
                        var9 = slot_var2_0_i32;
                        self.memory.store8(var2 as usize + 40, var5 as u8);
                        let mut slot_var2_32_i64 = var9 as i64;
                        slot_var2_24_i64 = var6 as i64;
                        slot_var2_16_i64 = var8 as i64;
                        'label6: loop {
                            'label7: loop {
                                let var22 = env.ledger().timestamp() as i64
                                var10 = var22;
                                var11 = var10 as i32 & 255;
                                if (var11 == 6) as i32 != 0 {
                                    break 'label7;
                                }
                                if (var11 != 64) as i32 != 0 {
                                    break 'label0;
                                }
                                let var23 = val_from_i64(var10).as_u64().unwrap_or(0) as i64
                                var10 = var23;
                                break 'label6;
                                break;
                            }
                            var10 = (var10 as u64).wrapping_shr(0 as u32) as i64;
                            break;
                        }
                        if (({ let a = (var10 as u64 >= var9 as u64) as i32; let b = (var10 as u64 <= var9 as u64) as i32; if var5 & 1 != 0 { a } else { b } }) == 0) as i32 != 0 {
                            break 'label1;
                        }
                        let var24 = { let v = Vec::<Val>::from_val(env, &val_from_i64(var6)); match v.first_index_of(val_from_i64(claimant)) { Some(i) => i as i64, None => 0 /* Void */ } }
                        if (var24 == 0 /* Void */) as i32 != 0 {
                            break 'label1;
                        }
                        if ({ let a = (var3 as u64 > var7 as u64) as i32; let b = (amount > var4) as i32; if (amount == var4) as i32 != 0 { a } else { b } }) != 0 {
                            break 'label1;
                        }
                        let var25 = val_to_i64(env.current_contract_address().into_val(env))
                        self.func21(env, var8, var25, claimant, var3, amount);
                        let var27 = amount;
                        amount = var4.wrapping_sub(amount).wrapping_sub(((var7 as u64) < var3 as u64) as i32 as u32 as i64);
                        if ((var4 ^ var27) & (var4 ^ amount) < 0 /* False */) as i32 != 0 {
                            break 'label0;
                        }
                        'label8: loop {
                            'label9: loop {
                                var4 = var7.wrapping_sub(var3);
                                if ({ let a = (var4 != 0 /* False */) as i32; let b = (amount > 0 /* False */) as i32; if (amount == 0) as i32 != 0 { a } else { b } }) != 0 {
                                    break 'label9;
                                }
                                let var28 = self.func26(env, 1);
                                let var29 = match 1 /* True */ { 0 => { env.storage().persistent().remove(&val_from_i64(var28)); 0 }, 1 => { env.storage().temporary().remove(&val_from_i64(var28)); 0 }, _ => { env.storage().instance().remove(&val_from_i64(var28)); 0 } }
                                var29;
                                break 'label8;
                                break;
                            }
                            let mut slot_var2_0_i64 = var4 as i64;
                            let mut slot_var2_8_i64 = amount as i64;
                            self.func25(env, var2);
                            break;
                        }
