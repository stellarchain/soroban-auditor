...
#[allow(dead_code)]
impl TokenContract.optimized {
    fn func15(&mut self, env: &Env, mut arg0: i32) {
        self.func16(env, arg0, 1 /* True */, 501120, 518400);
    }
    fn func16(&mut self, env: &Env, mut arg0: i32, mut arg1: i64, mut arg2: i32, mut arg3: i32) {
        let var4 = self.func17(env, arg0);
    ...
    fn func17(&mut self, env: &Env, mut arg0: i32) -> i64 {
        ...
        'label1: {
            'label2: {
                'label3: {
                    {
                        let var5 = mload32!(arg0 as usize) as i32;
                        match var5.wrapping_sub(1) {
                            0 => break,
                            1 => break,
                            2 => break,
                            _ => break,
                    ...
                    let var6 = self.func18(env, 1048729, 7);
                    let var7 = mload64!(arg0 as usize + 8) as i64;
                    let var8 = self.func19(env, var6, var7);
                    var4 = var8;
                    __exit_label0 = 1; break 'label1;
                }
                let var9 = self.func18(env, 1048736, 5);
                let var10 = mload64!(arg0 as usize + 8) as i64;
                let var11 = self.func19(env, var9, var10);
                var4 = var11;
                __exit_label0 = 1; break 'label1;
            }
            let var12 = self.func18(env, 1048741, 5);
            let mut slot_var1_0_i64 = var12 as i64;
            var4 = self.vec_new_val(env);
            __exit_label0 = 1; break 'label1;
        }
        if __exit_label0 == 0 {
        let var14 = self.func18(env, 1048720, 9);
        let var15 = mload64!(arg0.wrapping_add(16) as usize) as i64;
        let mut slot_var1_8_i64 = var15 as i64;
        let var16 = mload64!(arg0 as usize + 8) as i64;
        slot_var1_0_i64 = var16 as i64;
        let var17 = self.map_new_val(env, 1048664, 2, var1, 2);
        let var18 = self.func19(env, var14, var17);
        var4 = var18;
        }
    ...
    fn func19(&mut self, env: &Env, mut arg0: i64, mut arg1: i64) -> i64 {
        let mut var2: i32 = 0;
        let var3 = self.global0;
    ...
    fn func22(&mut self, env: &Env) -> i64 {
        let mut var0: i32 = 0;
        let mut var1: i64 = 0;
        let var2 = self.global0;
        var0 = var2.wrapping_sub(32);
        self.global0 = var0;
        let mut slot_var0_8_i64 = err_contract(0) as i64;
        loop {
            let var3 = self.func17(env, var0.wrapping_add(8));
            var1 = var3;
            let var4 = self.call_eq_one(env, var1, 0 /* Void */);
            if var4 != 0 {
    ...
    fn func24(&mut self, env: &Env, mut arg0: i64) {
        let mut var1: i32 = 0;
        let var2 = self.global0;
        var1 = var2.wrapping_sub(32);
        self.global0 = var1;
        let mut slot_var1_8_i64 = err_contract(0) as i64;
        let var3 = self.func17(env, var1.wrapping_add(8));
    ...
    fn func25(&mut self, env: &Env, mut arg0: i32, mut arg1: i64, mut arg2: i64) {
        ...
        var3 = var6.wrapping_add(-64);
        self.global0 = var3;
        mstore64!(var3.wrapping_add(16) as usize, arg2 as u64);
        let mut slot_var3_8_i64 = arg1 as i64;
        arg2 = 0 /* False */;
        let mut slot_var3_0_i64 = 0 /* False */ as i64;
        let mut __exit_label0: i32 = 0;
        loop {
            let var7 = self.func17(env, var3);
            arg1 = var7;
            let var8 = self.call_eq_one(env, arg1, 0 /* False */);
            if (var8 == 0) as i32 != 0 {
                arg1 = 0 /* False */;
                break;
            }
            let var9 = match 0 /* False */ { 0 => { val_to_i64(env.storage().persistent().get::<_, Val>(&val_from_i64(arg1)).unwrap_or(val_from_i64(0))) }, 1 => { val_to_i64(env.storage().temporary().get::<_, Val>(&val_from_i64(arg1)).unwrap_or(val_from_i64(0))) }, _ => { val_to_i64(env.storage().instance().get::<_, Val>(&val_from_i64(arg1)).unwrap_or(val_from_i64(0))) } }
            arg1 = var9;
                if (var4 != 16) as i32 != 0 {
                    mstore64!(var3.wrapping_add(24).wrapping_add(var4) as usize, 0 /* Void */ as u64);
            ...
            self.func26(env, arg1, 1048704, 2, var3.wrapping_add(24), 2);
            let mut slot_var3_24_i64 = mload64!(var3 as usize + 24) as i64;
            self.func27(env, var3.wrapping_add(40), slot_var3_24_i64);
            let mut slot_var3_40_i64 = mload64!(var3 as usize + 40) as i64;
            if ((slot_var3_40_i64 == 0) as i32 == 0) as i32 != 0 {
                __exit_label0 = 1; break 'label1;
            }
            let mut slot_var3_32_i64 = mload64!(var3 as usize + 32) as i64;
            arg1 = slot_var3_32_i64;
            if (arg1 & 255 != 0) as i32 != 0 {
                __exit_label0 = 1; break 'label1;
            }
            let mut slot_var3_48_i64 = mload64!(var3 as usize + 48) as i64;
            arg2 = slot_var3_48_i64;
            let var12 = mload64!(var3.wrapping_add(56) as usize) as i64;
            let var13 = self.func28(env);
            var4 = (arg1 as u64).wrapping_shr(32 as u32) as i64 as i32;
            var5 = (var13 as u32 > var4 as u32) as i32;
            arg1 = { let a = 0 /* False */; let b = var12; if var5 != 0 { a } else { b } };
            arg2 = { let a = 0 /* False */; let b = arg2; if var5 != 0 { a } else { b } };
        }
        if __exit_label0 == 0 {
        mstore64!(arg0 as usize + 8, arg1 as u64);
        mstore64!(arg0 as usize, arg2 as u64);
        mstore32!(arg0 as usize + 16, var4 as u32);
        self.global0 = var3.wrapping_sub(-64);
        return;
        }
        unreachable!();
    }
    fn func26(&mut self, env: &Env, mut arg0: i64, mut arg1: i32, mut arg2: i32, mut arg3: i32, mut arg4: i32) {
    ...
    fn func28(&mut self, env: &Env) -> i32 {
        let var0 = env.ledger().sequence() as i64
        (var0 as u64).wrapping_shr(32 as u32) as i64 as i32
    }
    fn func29(&mut self, env: &Env, mut arg0: i64, mut arg1: i64, mut arg2: i64, mut arg3: i64, mut arg4: i32) {
        let mut var5: i32 = 0;
        let mut var6: i32 = 0;
        ...
        self.global0 = var5;
        {
            var6 = { let a = (arg2 != 0 /* False */) as i32; let b = (arg3 > 0 /* False */) as i32; if (arg3 == 0) as i32 != 0 { a } else { b } };
            if (var6 == 0) as i32 != 0 {
                break;
            }
            let var8 = self.func28(env);
            if (var8 as u32 <= arg4 as u32) as i32 != 0 {
                break;
            }
            unreachable!();
        }
        mstore64!(var5.wrapping_add(32) as usize, arg1 as u64);
        let mut slot_var5_24_i64 = arg0 as i64;
        let mut slot_var5_16_i64 = 0 /* False */ as i64;
        mstore64!(var5.wrapping_add(56) as usize, arg1 as u64);
        let mut slot_var5_48_i64 = arg0 as i64;
        let mut slot_var5_40_i64 = 0 /* False */ as i64;
        let var9 = self.func17(env, var5.wrapping_add(40));
        self.func30(env, var5, arg2, arg3);
        let mut slot_var5_72_i64 = ((arg4 as u32 as i64).wrapping_shl(32 as u32) | 0) as i64;
        let mut slot_var5_8_i64 = mload64!(var5 as usize + 8) as i64;
        let mut slot_var5_64_i64 = slot_var5_8_i64 as i64;
        let var11 = self.map_new_val(env, 1048704, 2, var5.wrapping_sub(-64), 2);
        let var12 = match 0 /* False */ { 0 => { env.storage().persistent().set(&val_from_i64(var9), &val_from_i64(var11)); 0 }, 1 => { env.storage().temporary().set(&val_from_i64(var9), &val_from_i64(var11)); 0 }, _ => { env.storage().instance().set(&val_from_i64(var9), &val_from_i64(var11)); 0 } }
        var12;
        if var6 != 0 {
            let var13 = self.func28(env);
            var6 = var13;
            ...
            self.func16(env, var5.wrapping_add(16), 0 /* False */, arg4, arg4);
        }
        self.global0 = var5.wrapping_add(80);
    }
    fn func30(&mut self, env: &Env, mut arg0: i32, mut arg1: i64, mut arg2: i64) {
        let var3: i64;
        if (arg2 ^ arg1.wrapping_shr(63 as u32) != 0 /* False */) as i32 | (arg1.wrapping_sub(18410715276690587648) as u64 > 72057594037927935 as u64) as i32 != 0 {
    ...
    fn func31(&mut self, env: &Env, mut arg0: i32, mut arg1: i64) {
        ...
        var2 = var5.wrapping_sub(48);
        self.global0 = var2;
        let mut slot_var2_0_i64 = 1 /* True */ as i64;
        let mut slot_var2_8_i64 = arg1 as i64;
        arg1 = 0 /* False */;
        loop {
            let var6 = self.func17(env, var2);
            var3 = var6;
            let var7 = self.call_eq_one(env, var3, 1 /* True */);
            if var7 != 0 {
                ...
                self.func27(env, var2.wrapping_add(24), var8);
                let mut slot_var2_24_i64 = mload64!(var2 as usize + 24) as i64;
                if ((slot_var2_24_i64 == 0) as i32 == 0) as i32 != 0 {
                    break;
                }
                let var10 = mload64!(var2.wrapping_add(40) as usize) as i64;
                var4 = var10;
                let mut slot_var2_32_i64 = mload64!(var2 as usize + 32) as i64;
                arg1 = slot_var2_32_i64;
                self.func15(env, var2);
            }
    ...
    fn func32(&mut self, env: &Env, mut arg0: i64, mut arg1: i64, mut arg2: i64) {
        let mut var3: i32 = 0;
        let mut var4: i32 = 0;
        let var5 = self.global0;
        var3 = var5.wrapping_sub(48);
        self.global0 = var3;
        let mut slot_var3_24_i64 = 1 /* True */ as i64;
        let mut slot_var3_32_i64 = arg0 as i64;
        var4 = var3.wrapping_add(24);
        let var6 = self.func17(env, var4);
        self.func30(env, var3.wrapping_add(8), arg1, arg2);
        let mut slot_var3_16_i64 = mload64!(var3 as usize + 16) as i64;
        let var8 = match 1 /* True */ { 0 => { env.storage().persistent().set(&val_from_i64(var6), &val_from_i64(slot_var3_16_i64)); 0 }, 1 => { env.storage().temporary().set(&val_from_i64(var6), &val_from_i64(slot_var3_16_i64)); 0 }, _ => { env.storage().instance().set(&val_from_i64(var6), &val_from_i64(slot_var3_16_i64)); 0 } }
        var8;
        self.func15(env, var4);
        self.global0 = var3.wrapping_add(48);
    }
    fn func33(&mut self, env: &Env, mut arg0: i64, mut arg1: i64, mut arg2: i64) {
        let mut var3: i32 = 0;
        let mut var4: i64 = 0;
        let mut var5: i64 = 0;
        let var6 = self.global0;
        var3 = var6.wrapping_sub(16);
        self.global0 = var3;
        self.func31(env, var3, arg0);
        let var8 = mload64!(var3.wrapping_add(8) as usize) as i64;
        var4 = var8;
        let var9 = arg2;
        let mut slot_var3_0_i64 = mload64!(var3 as usize) as i64;
        var5 = slot_var3_0_i64;
        arg1 = arg1.wrapping_add(var5);
        arg2 = (((arg1 as u64) < var5 as u64) as i32 as u32 as i64).wrapping_add(arg2.wrapping_add(var4));
        if ((var4 ^ var9 ^ 18446744073709551615) & (var4 ^ arg2) >= 0 /* False */) as i32 != 0 {
            self.func32(env, arg0, arg1, arg2);
            self.global0 = var3.wrapping_add(16);
            return;
        }
        unreachable!();
    }
    fn func34(&mut self, env: &Env, mut arg0: i64, mut arg1: i64, mut arg2: i64) {
        let mut var3: i32 = 0;
        let mut var4: i32 = 0;
        let mut var5: i64 = 0;
        let mut var6: i64 = 0;
        ...
        loop {
            let mut slot_var3_0_i64 = mload64!(var3 as usize) as i64;
            var6 = slot_var3_0_i64;
            var4 = ((var6 as u64) < arg1 as u64) as i32;
            let var9 = mload64!(var3.wrapping_add(8) as usize) as i64;
            var5 = var9;
            if (({ let a = var4; let b = (var5 < arg2) as i32; if (arg2 == var5) as i32 != 0 { a } else { b } }) == 0) as i32 != 0 {
                let var10 = arg2;
                arg2 = var5.wrapping_sub(arg2).wrapping_sub(var4 as u32 as i64);
                if ((var10 ^ var5) & (var5 ^ arg2) >= 0 /* False */) as i32 != 0 {
                    break;
                }
                unreachable!();
            }
        ...
        self.func32(env, arg0, var6.wrapping_sub(arg1), arg2);
        self.global0 = var3.wrapping_add(16);
    }
    fn func35(&mut self, env: &Env, mut arg0: i64, mut arg1: i64) {
    ...
    fn func39(&mut self, env: &Env, mut arg0: i32) -> i64 {
        let mut var1: i32 = 0;
        let mut var2: i64 = 0;
        let var3 = self.global0;
    ...
    fn func41(&mut self, env: &Env, mut arg0: i64, mut arg1: i64) -> i64 {
        let mut var2: i32 = 0;
        let mut var3: i32 = 0;
        ...
        self.global0 = var3;
        let mut slot_var3_8_i64 = arg1 as i64;
        let mut slot_var3_0_i64 = arg0 as i64;
        let var5: i64;
        loop {
            let var6: i64;
            if (var2 == 16) as i32 != 0 {
                var2 = 0;
                    if (var2 != 16) as i32 != 0 {
                        let var7 = mload64!(var2.wrapping_add(var3) as usize) as i64;
                        mstore64!(var3.wrapping_add(16).wrapping_add(var2) as usize, var7 as u64);
                        var2 = var2.wrapping_add(8);
                        continue;
                    }
                let var8 = self.vec_new_val(env);
                self.global0 = var3.wrapping_add(32);
                var6 = var8;
            }
            else {
                mstore64!(var3.wrapping_add(16).wrapping_add(var2) as usize, 0 /* Void */ as u64);
                var2 = var2.wrapping_add(8);
                continue;
                // There should've been an expression value here, but this may be unreachable
                unreachable!();
    ...
    fn func46(&mut self, env: &Env, mut arg0: i64, mut arg1: i64, mut arg2: i64, mut arg3: i64) {
        let mut var4: i32 = 0;
        let var5 = self.global0;
        var4 = var5.wrapping_sub(48);
        self.global0 = var4;
        let mut slot_var4_40_i64 = arg1 as i64;
        let mut slot_var4_32_i64 = arg0 as i64;
        let mut slot_var4_24_i64 = transfer as i64;
        let var6 = self.func39(env, var4.wrapping_add(24));
        self.func30(env, var4.wrapping_add(8), arg2, arg3);
        let mut slot_var4_16_i64 = mload64!(var4 as usize + 16) as i64;
        let var8 = { env.events().publish(val_from_i64(var6), val_from_i64(slot_var4_16_i64)); 0 }
        var8;
        self.global0 = var4.wrapping_add(48);
    }
    fn func51(&mut self, env: &Env, mut arg0: i32, mut arg1: i64) {
        let mut var2: i32 = 0;
        let mut var3: i32 = 0;
        let mut var4: i64 = 0;
        let mut var5: i64 = 0;
        ...
        self.global0 = var2;
        self.zero_24_bytes(var2.wrapping_add(8));
        loop {
            let mut __exit_label2: i32 = 0;
            {
                if (Map::<Val, Val>::try_from_val(env, &val_from_i64(arg1)).is_ok()) as i32 != 0 {
                    self.func26(env, arg1, 1048816, 3, var2.wrapping_add(8), 3);
                    ...
                    if (!(String::try_from_val(env, &val_from_i64(var4)).is_ok())) as i32 != 0 {
                    ...
                    if (String::try_from_val(env, &val_from_i64(var5)).is_ok()) as i32 != 0 {
                        mstore64!(arg0 as usize + 8, var4 as u64);
                        mstore64!(arg0 as usize, 0 /* False */ as u64);
                        mstore32!(arg0.wrapping_add(24) as usize, (arg1 as u64).wrapping_shr(32 as u32) as i64 as u32);
                        mstore64!(arg0.wrapping_add(16) as usize, var5 as u64);
                        break;
                    }
